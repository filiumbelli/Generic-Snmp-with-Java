...
public class OidManager {
    ...
    // Easier way to check the oid | It can be managed over DeviceHolder
    public static Object[] getV2OidValue(String oidValue, String ipAddress) {
        return getOidValue(oidValue, "public", "162", ipAddress, 2);
    }

    // Try to get the oid else throws NullPointException
    ...
    // Set the given device Oid Value
